...
\clearpage
%% =============================================================================
\subsection{Miscellanous helpers mostly for time dependent covariates}

Maybe document these functions here at some point:

\begin{itemize}
\item \texttt{event1trunc}
\item \texttt{tstart2zero}
\item \texttt{time\_num2date} and \texttt{time\_date2num}
\item \texttt{cbin}
\item \texttt{state2event}
\item \texttt{tdc\_statistic}, \texttt{tdc\_calculator}, and \texttt{tdc\_count}
\end{itemize}
